...
<activation critical="MANDATORY">
      ...
      <step n="4">Load into memory {project-root}/_bmad/_config/project-config.yaml and set variable project_name, output_folder, user_name, communication_language</step>
